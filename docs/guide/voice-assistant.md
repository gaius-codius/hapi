...
The assistant bridges voice communication with your active coding agent (Claude Code, Codex, Gemini, OpenCode, or Cursor), relaying your requests and summarizing responses in natural speech.
