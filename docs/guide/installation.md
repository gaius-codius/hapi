...
- Claude Code, OpenAI Codex CLI, Google Gemini CLI, OpenCode CLI, or Cursor CLI installed
...
|-----------|------|----------|
| **CLI** | Wraps AI agents (Claude/Codex/Gemini/OpenCode/Cursor), runs sessions | Yes |
